    ...
    return (
        <div className={styles.signUp}>
            ...
            <div className={styles.test}>
                <div>Email: testinna@gmail.com</div>
                <div>Password: 123123123</div>
            </div>
            <form onSubmit={formik.handleSubmit}>
                <label className={formik.touched.email && formik.errors.email ? styles.errorField : ''}>
                    ...
                    <div
                        className={styles.error}>{formik.touched.email && formik.errors.email && formik.errors.email}</div>
                </label>
                <label className={formik.touched.password && formik.errors.password ? styles.errorField : ''}>
                    ...
                    <div
                        className={styles.error}>{formik.touched.password && formik.errors.password && formik.errors.password}</div>
                </label>
